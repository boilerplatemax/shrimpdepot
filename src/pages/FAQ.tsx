const faqs = [
  ...
  },
  {
    ...
    a: "After placing your order, we'll reach out to arrange a convenient pickup time and location. Just contact us through the contact page if you have any questions before ordering.",
  },
  {
